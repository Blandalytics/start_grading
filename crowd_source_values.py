...
st.set_page_config(page_title='MLB Start Grading', page_icon=letter_logo)
...
game_line_text = f'{ip_adj:.1f} IP, {earned_runs} ER, {hit_text}{xbh_text}, {walk_text}, {strikeout_text}'
...
with col2:
    if st.button("Submit Grade"):
        ...
        attempts = 0
        while (grade_df.shape[0]==0) & (attempts <5):
